...
export const ReturnBook = () => {
  ...
  return (
    <div className="admin-dashboard">
      <AdminSidebar />
      <div className="admin-return-book-main-content shrink">
        <div className="mb-2">
        ...
        <Container className="d-flex justify-content-center align-items-center h-100">
          <Card className="p-4 return-book-container">
            <h5 className="text-center fw-bold mb-4 return-book-heading">RETURN BOOK</h5>
            ...
            <Formik
              ...
              onSubmit={async (values, { resetForm }) => {
                try {
                  ...
                  const response = await axios.post("http://localhost:3000/library/return-book", payload, {
            ...
            >
              {({ handleSubmit, handleChange, handleBlur, values, touched, errors }) => (
                <Form noValidate onSubmit={handleSubmit} className="form-data">
                  ...
                  <Button type="submit" className="w-100 submit-btn">Return Book</Button>
                </Form>
              )}
            </Formik>
          </Card>
